<template>
  <div>
    <div  class="form p-5 relative flex flex-col text-black mt-10 rounded-lg">
      ...
      <input class="mb-5" type="text" v-model="newPost.image" placeholder="Url Background Image">
      <input class="mb-5" type="text" v-model="newPost.userImg" placeholder="Url User Image">
